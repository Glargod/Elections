...
Not at all. The [flowchart](flowchart.png) illustrates this: voters choose Core Mode (10-15 questions) for accessibility or Full Policy Mode (50-100) for depth. Questions are themed (e.g., economy, healthcare) and spread over a week, with progress saved. Mobile polling stations and simplified versions (5 questions) ensure inclusivity, balancing depth with ease. PolicyMatch is a two-stage tool: recommendation first, then voter confirmation.

**3. How do you ensure PolicyMatch questions aren’t biased?**  
An independent commission verifies the question bank (50-100 questions covering mandates and counterpoints) for fairness. PlatformEval AI provides objective summaries (e.g., “Dental care: $2.88B/year, rural access strain”), balancing perspectives. The process is transparent, with public reports and post-vote explanations (e.g., “Your answers pointed to PPC; you then confirmed or changed that choice.”). PolicyMatch does not cast the vote: answers produce a ranked alignment; the voter sees the person attached to it and must confirm, switch, or add valence questions before any ballot is recorded.
...
Activists value its focus on voter empowerment, policy-driven outcomes, and transparency, addressing distrust in elections. Party leaders benefit from votes aligning with platforms after the voter confirms the recommended alignment, reducing emotional manipulation, while the flowchart shows a clear, fair process. Bipartisan appeal—transparency for conservatives, education for progressives—ensures broad support.
